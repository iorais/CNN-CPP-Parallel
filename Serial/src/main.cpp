...
vector<int> image_2{8,26,26}, kernels_2{2,3,3,8},  hidden{24*24*2};
...
int main(int argc, char ** argv){
    ...
    network.add_conv(image_1, kernels_1, padding= 0, stride= 1, bias= 0.1, eta= 0.01 );
    network.add_conv(image_2 , kernels_2 , padding= 0, stride= 1, bias= 0.1, eta= 0.01);
    network.add_dense(input_layer=2*24*24, hidden, num_classes=10, bias=1.0,  adam=false, eta=0.5);
